...
ITSQ_FIT_ITERATION_COUNT=5000                           ## maximum number of iterations for curve fitting 250-10000
...
IV_SAG_SS_TARGET_VOLTAGE=0.025                          ## sagratio will be measured for the frame for which sag steady state is the closest of this value (in V)
...
IV_CURRENT_STEPS=[-95+5*i for i in range(39)]           ## list of current steps applied during IV protocol
...
AHP_VALID_COMBO=[(5,20)]                                ## used to generate the list of AHP output fields
...
## process flags
PROCESS_PROTOCOLS=['foldername','iv','rheobase','ahp','ramp']
